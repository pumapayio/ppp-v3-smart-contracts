...
const RecurringPullPaymentWithFreeTrial = artifacts.require(
  "RecurringPullPaymentWithFreeTrial"
);
const RecurringPullPaymentWithPaidTrial = artifacts.require(
  "RecurringPullPaymentWithPaidTrial"
);
const RecurringDynamicPullPayment = artifacts.require(
...
module.exports = async (deployer, _networkName, _accounts) => {
  try {
    const contractAddresses = {
      ...
      RecurringPullPaymentWithFreeTrial:
        "0xEdB12AD30dEc412F3ce7859DFFDd82a107fFa6E5",
      RecurringPullPaymentWithPaidTrial:
        "0xB75A3b4A4DA2F2043Ed5Fc6d92669821C4d2f846",
